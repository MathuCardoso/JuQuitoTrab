        ...
        <div class="col-6">
            <form id="frmVisita" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nomeVisitante" id="txtNome" class="form-control" value="<?php echo ($visita ? $visita->getNomeVisitante() : ''); ?>" />
                </div>

                <div class="form-group">
                    <label for="txtCpf">CPF:</label>
                    <input type="number" name="cpf" id="txtCpf" class="form-control" value="<?php echo ($visita ? $visita->getCpf() : ''); ?>" />
                </div>

                <div class="form-group">
                    <label for="txtData">Data da visita:</label>
                    <input type="date" name="dataVisita" id="txtData" class="form-control" value="<?php echo ($visita ? $visita->getDataVisita() : ''); ?>" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="selIdolo" name="idolo" class="form-control">
                        ...
                        <?php foreach ($idolo as $i) : ?>
                            <option value="<?= $i->getId(); ?>" <?php
                                                                if (
                                                                    $visita && $visita->getIdolos() &&
                ...
                <input type="hidden" name="id" value="<?php echo ($visita ? $visita->getId() : 0); ?>" />
                ...
                if (!$visita || $visita->getId() <= 0) {
                    echo '<button type="button" class="btn btn-success" onclick="inserirVisitante();">Cadastrar</button>';
                } else {
                    echo '<button type="submit" class="btn btn-success">Alterar</button>';
                }
